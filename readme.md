...
- **Docker Tooling Integration**:
  ...
  - **ระบบติดตั้งในตัว**: หากเครื่องของคุณยังไม่มี Docker CLI หรือ Docker Compose สามารถกดติดตั้งผ่านปุ่ม **"Install"** ใน Sidebar ของโปรแกรมได้ทันที หรือติดตั้งเองผ่าน Terminal ด้วยคำสั่ง `brew install docker docker-compose`
